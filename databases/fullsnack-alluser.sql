...
--
-- Host: localhost
-- Generation Time: Apr 21, 2018 at 05:32 PM
...
CREATE TABLE `collection_member` (
  ...
  `member_hash` varchar(255) NOT NULL,
  `member_status` enum('confirmed','unconfirm','','') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `collection_member`
--

INSERT INTO `collection_member` (`no`, `member_id`, `member_email`, `member_password`, `member_hash`, `member_status`) VALUES
(31, 'MEM20180421173055', 'anticoding101@gmail.com', 'adcd7048512e64b48da55b027577886ee5a36350', '163a067f78904a692eb851643a97161718d471a7', 'confirmed');
