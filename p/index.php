...
if($session == true){
  header("location: http://fullsnack.org/p/users/profile");
}
...
<body>
   ...
   <nav class="white lighten-1" role="navigation">
            <div class="nav-wrapper container">
              <a id="logo-container" href="http://fullsnack.org/" class="brand-logo">fullsnack</a>
...
<form method="POST" action="">
	...
	<ul class="stepper linear animated SlideInLeft">
      <li class="step active">
      <div class="step-title waves-effect">E-mail</div>
      <div class="step-content">
         <div class="row">
            <div class="input-field col s12">
               <input id="email" name="email" type="email" required class="validate" autofocus>
