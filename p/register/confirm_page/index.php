...
<body>
  ...
  <main class="animated LightSpeedIn">
    <center>
      ...
      <h5 class="indigo-text">SELAMAT BERGABUNG!</h5>
      <div class="section"></div>
      ...
      <div class="container">
        <div class="z-depth-1 grey lighten-4 row" style="display: inline-block; padding: 32px 48px 0px 48px; border: 1px solid #EEE;">
          ...
          <div class="col s12">
            ...
            <div class='row'>
              <div class='col s12'>
                <h3>Terimakasih telah mendaftar, sistem kami telah mengirimkan email konfirmasi.</h3>
                <h3>Cek dan aktivasi akun kamu sekarang!</h3>
              </div>
            </div>
            ...
            <center>
              <div class='row'>
                <a href="http://gmail.com" class='col s12 btn btn-large waves-effect indigo'>Aktivasi Akun</a>
              </div>
            </center>
